...
import com.example.aivoicechanger.databinding.FragmentVoicesBinding
...
class VoicesFragment : Fragment(), OnVoiceCallback {

    val binding: FragmentVoicesBinding by lazy {
        FragmentVoicesBinding.inflate(layoutInflater)
    }
